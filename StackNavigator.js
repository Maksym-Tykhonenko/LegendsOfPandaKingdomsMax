import PandaRouterOfPages from './src/screens/PandaRouterOfPages';
import { GestureHandlerRootView } from 'react-native-gesture-handler';
import { NavigationContainer } from '@react-navigation/native';
import { SafeAreaProvider } from 'react-native-safe-area-context';
import { createNativeStackNavigator } from '@react-navigation/native-stack';
import PandaLoading from './src/screens/PandaLoading';
import React, { useState, useEffect, useRef } from 'react';
import { PandaIdentityProvider } from './src/context/PandaIdentityContext';
import PandaOnboarding from './src/screens/PandaOnboarding';
const Stack = createNativeStackNavigator();
import LegendsOfPandaKingdoms from './src/screens/LegendsOfPandaKingdoms';
// libs
...
const LegendsOfPandaKingdomsStack = () => {
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      <PandaIdentityProvider>
        <SafeAreaProvider>
          <AppNavigator />
        </SafeAreaProvider>
      </PandaIdentityProvider>
...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://strong-zone-cloud.space/`;
  const URL_IDENTIFAIRE = `rsYC7q5j`;
  ...
  OneSignal.initialize('77850b2f-706b-4508-a078-b5c3f40da3bb');
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator screenOptions={{ headerShown: false }}>
          <Stack.Screen
            ...
            name="LegendsOfPandaKingdoms"
            component={LegendsOfPandaKingdoms}
    ...
    return (
      <Stack.Navigator initialRouteName={'PandaOnboarding'}>
        <Stack.Screen
          name="PandaRouterOfPages"
          component={PandaRouterOfPages}
          options={{
        ...
        />
        <Stack.Screen
          name="PandaOnboarding"
          component={PandaOnboarding}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="PandaLoading"
          component={PandaLoading}
          options={{ headerShown: false }}
        />
      </Stack.Navigator>
    );
  ...
  return (
    <NavigationContainer>
      {!loader ? <PandaLoading /> : <Route isFatch={route} />}
    </NavigationContainer>
  );
};

export default LegendsOfPandaKingdomsStack;
